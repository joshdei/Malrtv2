            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form   action = "/createsupertelegramlink" method = "post" class="forms-sample">
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Super Telegram Link</label>
                        <input type="text" class="form-control" name ="supertelegramlink" id="exampleInputUsername1" placeholder="Super Telegram Link">
                      </div>
