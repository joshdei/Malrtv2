        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Mixer telegram link</h4>
                    <p class="card-description">
                      Basic form layout
                    </p>
                    <form   action = "/mixertelegramlink" method = "post" class="forms-sample">
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Mixer  Telegram Link</label>
                        <input type="text" class="form-control" name ="mixertelegramlink" id="exampleInputUsername1" placeholder="Super Telegram Link">
                      </div>
