            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form   action = "/createtelegramlink" method = "post" class="forms-sample">
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Telegram Link</label>
                        <input type="text" class="form-control" name ="telegramlink" id="exampleInputUsername1" placeholder="Telegram Link">
                      </div>
