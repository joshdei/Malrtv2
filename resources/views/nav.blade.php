...
<html>
    ...
    <!-- User is authenticated -->
								...
								?>
								@if ($checkUser)
									<!-- User is verified in the other database -->
									<li>
									<a href="post" class="dropdown-toggle no-arrow">
										<span class="micon bi bi-calendar4-week"></span
										><span class="mtext">Post</span>
									</a>
									</li>
								@else
									<!-- User is not verified in the other database -->
									<li>
									<a href="upgrade" class="dropdown-toggle no-arrow">
										<span class="micon bi bi-calendar4-week"></span
										><span class="mtext">Upgrade</span>
									</a>
									</li>
								@endif
							@else
