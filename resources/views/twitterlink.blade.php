        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Twitter form</h4>
                    <p class="card-description">
                      Basic form layout
                    </p>
                    <form   action = "/createtwitterlink" method = "post" class="forms-sample">
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputUsername1">Twitter Link</label>
                        <input type="text" class="form-control" name ="twitterlink" id="exampleInputUsername1" placeholder="Telegram Link">
                      </div>
