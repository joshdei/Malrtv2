        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse"  aria-expanded="false" aria-controls="auth">
              ...
              <span class="menu-title">Logout  Pages</span>
              <i class="menu-arrow"></i>
            </a>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">super telegram link</h4>
                    <p class="card-description">
                      Basic form layout
                    </p>
                    <form   action = "/editelegramlinkss/<?php echo $links[0]->id; ?>" method = "post" class="forms-sample">
                        @csrf
                     ...
                     <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Super Telegram Link</label>
                        <input type="text" class="form-control" value = '<?php echo$links[0]->telegramlink; ?>' name ="telegramlink" id="exampleInputUsername1" placeholder="Super Telegram Link">
